...
import { Card, type Item } from "../base/Card";
...
export const InappEscape = () => {
  ...
  const escapeLinks = {
    iOS: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: (
            <p style={{ marginTop: 25, marginBottom: 8 }}>
              Experiment with the less reliable search and browser links below.
            </p>
          ),
        },
        {
        ...
        { type: "link", title: "Opera", href: "touch-https://example.com" },
        {
          type: "link",
          title: "Yandex",
    ...
    Android: {
      intro: (
        <>
          <p>
            To reliably exit in-app browsers on Android devices, use the default
            browser intent link.
          </p>
          <p>
  ...
  type EscapeLinksVendor = keyof typeof escapeLinks;
